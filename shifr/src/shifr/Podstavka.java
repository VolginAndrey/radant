...
public class Podstavka extends javax.swing.JFrame {

    /**
     * Creates new form Подстановка
     */
    public Podstavka() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jTextField2.setText(alfitog);
        for (int pos = 0; pos <al; pos++){
        alfNewSet=alfNewSet+alfNew[pos];
        }
        jTextArea1.setText(alfNewSet);
        }
    }//GEN-LAST:event_jButton1ActionPerformed

/**
 * @pam args the command line arguments
 */
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Podstavka.class
